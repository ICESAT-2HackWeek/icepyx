...
import icepyx.core.hdf5_arrow_table as hat
# Assuming the HDF5ArrowTableCreator class and related classes are already defined above this
...
class TestHDF5ArrowTableCreator(TestCase):
    ...
    def test_create_table(self):
        ...
        creator = hat.HDF5ArrowTableCreator(
